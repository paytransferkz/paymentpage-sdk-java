...
{
    /**
     * kz.paytransfer.sdk.SignatureHandler instance for check signature
     */
    private SignatureHandler signatureHandler;

    /**
     * kz.paytransfer.sdk.PaymentPage instance for build payment URL
     */
    private PaymentPage paymentPageUrlBuilder;

    /**
     * kz.paytransfer.sdk.Gate constructor
     ...
     * @param payment kz.paytransfer.sdk.Payment instance with payment params
     ...
     * @return kz.paytransfer.sdk.Callback instance
